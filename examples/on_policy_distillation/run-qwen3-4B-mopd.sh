...
# Teacher 0: Qwen3-4B-Instruct-2507
# Teacher 1: Qwen3-4B-Thinking-2507
#
...
CKPT_ARGS=(
   ...
   # --save ${MODEL_DIR}/Qwen3-4B-MOPD-output/
   # --save-interval 20
)
...
GRPO_ARGS=(
   ...
   --megatron-config-path ${SCRIPT_DIR}/mopd_config_4B.yaml
)
