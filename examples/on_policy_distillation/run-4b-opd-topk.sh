...
pkill -9 ray
pkill -9 python
# usage: bash examples/on_policy_distillation/run-4b-opd-topk.sh
# OPD with Top-K strategy (Qwen3-30B-A3B teacher -> Qwen3-4B student)
